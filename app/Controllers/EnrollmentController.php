...
//     }
    ...
    public function whoAmI(Request $request){
        ...
        return Enrollment::where('loyalty_number', $request->loyalty_number)->select('email', 'first_name', 'last_name', 'member_cif')->first();
    }

    public function whoAmI2(Request $request){
        //return $request->all();
		//print_r(Enrollment::where('id', '>', 0)->get());
        return Enrollment::where('member_cif', $request->member_cif)->select('email', 'first_name', 'last_name', 'loyalty_number')->first();
    }
